        ...
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    ...
                    <Card key={kpi.label} className="kpi-card overflow-hidden border-border/50 bg-card/60">
                        <div className={`pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r ${kpi.accent}`}/>
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-xs font-medium text-muted-foreground">{kpi.label}</span>
                                <div className={`w-8 h-8 rounded-lg ${kpi.ring} flex items-center justify-center`}>
                                    {kpi.icon}
                                </div>
                            </div>
                    ...
                    <CardContent className="pt-0">
                        {recentMeals.length === 0 ? (
                            <div className="py-8 text-center text-sm text-muted-foreground">
                                No meals logged yet.{" "}
                                <Link href="/log" className="text-primary underline">Log your first meal</Link>
                            </div>
                        ) : (
            ...
            <Card className="border-emerald-500/20 bg-gradient-to-br from-emerald-950/40 to-teal-950/20">
                <CardContent className="p-5 flex gap-4 items-start">
                    <div
                        className="w-9 h-9 rounded-lg bg-emerald-500/10 flex items-center justify-center shrink-0 mt-0.5">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            like your <span
                            className="text-foreground font-medium">Salmon & Roasted Veggies</span> and{" "}
