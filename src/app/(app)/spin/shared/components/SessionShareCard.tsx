 ...
 */
export function SessionShareCard({ code, joinUrl, isHost }: SessionShareCardProps) {
    ...
    return (
        <div className="w-full space-y-3">
                ...
                <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-sm">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Ask others to scan this QR code to join using code {code}.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="flex flex-col items-center gap-3 py-1">
                            ...
                            <Button
                                ...
                                aria-label={copiedLink ? "Join link copied" : "Copy join link"}
                            >
                                {copiedLink ? (
            ...
            <div className="min-w-0 space-y-2">
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            aria-label={copiedCode ? "Code copied!" : `Copy session code ${code}`}
                        >
                            {copiedCode ? (
                ...
                <p className="text-xs text-muted-foreground">Use Share to show the join QR code.</p>
            </div>
        </div>
    );
}
