                            ...
                            <Controller
                                ...
                                render={({field}) => (
                                    <Select
                                        ...
                                        data={MEAL_TYPES.map((t) => ({value: t, label: t}))}
                            ...
                            {items.map((food, index) => (
                                <div key={food.id} className="space-y-1">
                                                ...
                                                <div className="col-span-2 min-w-0 sm:col-span-1 sm:flex-1">
                                                    <Autocomplete
                                                        value={field.value ? {
                                                            ...
                                                            name: field.value,
                                                        } satisfies FoodSearchItem : null}
                                                        error={Boolean(errors.items?.[index]?.foodName)}
                                                        onChange={(selectedFood) => {
                                                            field.onChange(selectedFood.name);
                                                            setValue(`items.${index}.foodSourceId`, selectedFood.id, {
                                                                shouldDirty: true,
                                                                shouldValidate: true,
                                                            });
                                                            setValue(`items.${index}.foodSource`, "catalog", {
                                                                shouldDirty: true,
                                                                shouldValidate: true,
                                                            });
                                                        }}
                                    ...
                                    {errors.items?.[index]?.quantity && (
                                        <p className="text-[10px] text-destructive px-1">{errors.items[index].quantity.message}</p>
                                    )}
                                </div>
                            ))}
                        </div>
